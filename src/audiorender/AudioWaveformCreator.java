...
public class AudioWaveformCreator {
  ...
  //AH 18/02/2013
  public AudioWaveformCreator(){
      file = null;
      this.waveformFilename = null;
  }
...
//        reportStatus(ex.toString());
        ...
        Logger.getLogger(AudioWaveformCreator.class.getName()).log(Level.SEVERE, "Audio file required.");
//      reportStatus("Audio file required.");
  ...
  /**
   * Function to work with large wav files
   * @param ais
   * @param w
   * @param h
   * @return
   * @throws Exception 
   */
  public BufferedImage createSplittedAudioInputStream(AudioInputStream ais,int w, int h) throws Exception{
      this.audioInputStream = ais;
      long milliseconds = (long) ((ais.getFrameLength() * 1000) / ais.getFormat().getFrameRate());
        duration = milliseconds / 1000.0;
        //System.out.println("Duration in seconds : "  +duration);
        samplingGraph = new SamplingGraph(w, h);
        return samplingGraph.createWaveFormToImg(null);
  }
  ...
  class SamplingGraph implements Runnable {
    ...
    Color jfcCourbeColor = new Color(000, 000, 000);
    Color pink = new Color(255, 75, 75);
    private int w;
    private int h;

    public SamplingGraph(int w, int h) {
      this.w = w;
      this.h = h;
    }
    ...
    public void saveToFile(String filename) {
      ...
      // Cropping the image
      bufferedImage = ImageCropper.getCroppedImage(bufferedImage);
      g2.dispose();
    ...
    public BufferedImage createWaveFormToImg(byte[] audioBytes) {
      ...
      return saveToUncroppedImage();
    }
    
    public BufferedImage saveToUncroppedImage(){
        int INFOPAD = 15;
        ...
        while ((capture.line != null && !capture.line.isActive())) {
          try {
            thread.sleep(10);
              ...
              Logger.getLogger(AudioWaveformCreator.class.getName()).log(Level.SEVERE, null, e);
            break;
          }
        }
      }
...
//        shutDown("Line matching " + info + " not supported.");
        String in = "Line matching " + info + " not supported.";
         Logger.getLogger(AudioWaveformCreator.class.getName()).log(Level.SEVERE, in);
        return;
      }
