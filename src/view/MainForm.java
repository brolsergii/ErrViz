...
public class MainForm extends javax.swing.JFrame {
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            clearHighlighting();
            //System.out.println("double click spotted : "+jList1.getSelectedValue()+"\n");
            //beurk
...
//        System.out.println("value : "+(String) jList1.getSelectedValue());
    ...
    public void highlightTextSaidBySelectedSpeaker(String name) {
        //System.out.println("highlightTextSaidBySelectedSpeaker");
//      clearHighlighting();
        if (STM.getInstance().isLoaded() && CTM.getInstance().isLoaded()) {
    ...
    public void highlightSectors(ArrayList<Sector> aSectorList) {
        ...
        try {
            while (it.hasNext()) {
                s = it.next();
                jTextPane1.getHighlighter().addHighlight(s.getPosition(), s.getPosition() + s.getLengthInChars(), new DefaultHighlightPainter(Color.BLUE));
            }
        } catch (Exception ex) {
            System.err.println(ex);
        }
...
//        System.out.println("STM loaded : "+STM.getInstance().isLoaded());
//        System.out.println("CTM loaded : "+CTM.getInstance().isLoaded());
        if (CTM.getInstance().isLoaded() && !STM.getInstance().isLoaded()) {
            //for the moment, do nothing if stm isn't loaded
//            System.out.println("CTM.getInstance().isLoaded() && !STM.getInstance().isLoaded() : "+CTM.getInstance().isLoaded()+" "+STM.getInstance().isLoaded());
//            jList1.setListData(SpeakersUtilities.getSpeakers(CTM.getInstance().getSectors()));
        } else if (STM.getInstance().isLoaded()) {
//            System.out.println("STM.getInstance().isLoaded() : "+STM.getInstance().isLoaded());
