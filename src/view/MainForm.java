...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        menu = PropertiesHelper.getMenu();
        initComponents();
        /*init menu in locale language*/
        this.jMenu1.setText(menu.getString("menu.file"));
        this.jMenuItem1.setText(menu.getString("menu.clean"));
        this.jMenu3.setText(menu.getString("menu.load"));
        this.jCheckBoxMenuItem1.setText(menu.getString("menu.stm"));
        this.jCheckBoxMenuItem2.setText(menu.getString("menu.ctm"));
        this.jCheckBoxMenuItem3.setText(menu.getString("menu.wav"));
        this.jMenuItem4.setText(menu.getString("menu.exit"));
        this.jMenuItem5.setText(menu.getString("menu.all"));
        this.jMenu2.setText(menu.getString("menu.help"));
        this.jMenuItem3.setText(menu.getString("menu.manual"));
        this.jMenuItem2.setText(menu.getString("menu.about"));
        this.jMenu4.setText(menu.getString("menu.languages"));
        
        /*init application*/
        this.jLabel1.setText(application.getString("application.header"));
        this.jLabel2.setText(application.getString("application.errors"));
        this.jLabel3.setText(application.getString("application.extraInfo"));
        this.jLabel4.setText(application.getString("application.speakers"));
        this.jButton1.setText(application.getString("application.previousError"));
        this.jButton2.setText(application.getString("application.nextError"));
        this.jButton3.setText(application.getString("application.all"));
        this.jButton4.setText(application.getString("application.play"));
        this.jButton5.setText(application.getString("application.pause"));
        this.jButton6.setText(application.getString("application.stop"));
        this.jComboBox2.setModel(new DefaultComboBoxModel(new String[] {
            application.getString("application.allErrors"),
...
//         boolean res = OutputHelper.askQuestion("Are you sure you want to quit?", "Exit");
        boolean res = OutputHelper.askQuestion(application.getString("application.exitConfirmation"), application.getString("application.exit"));
        if (res) {
            System.exit(0);
        }
    }
...
//        this.setTitle("Cleaned");
         this.setTitle(application.getString("application.cleaned"));
...
//            System.err.println(e);
        ...
        if (STM.getInstance().isLoaded() && CTM.getInstance().isLoaded()) {
            ...
            int updatedIndex = 0; //AH 20/02/2013
            try {
                for (int index = 0; index < controller.STM.getInstance().getSectors().size(); index++) {
                    ...
                    //AH 20/02/2013 Bug correction : index is now displayed from 1 to x+1 instead of 0 to x
                    updatedIndex = index + 1;
                    String tmpStr = "" + updatedIndex + "\n";
...
//                extraInfo += "ID: " + selected.getID() + "\n";
                extraInfo += application.getString("application.id")+": " + selected.getID() + "\n";
//                extraInfo += "Word: " + selected.getWord() + "\n";
                extraInfo += application.getString("application.word")+": " + selected.getWord() + "\n";
//                extraInfo += "Position: " + selected.getPosition() + "\n";
                extraInfo += application.getString("application.position")+": " + selected.getPosition() + "\n";
//                extraInfo += "Length: " + selected.getLength() + "\n";
                extraInfo += application.getString("application.length")+": " +  selected.getLength() + "\n";
...
//                extraInfo += "Length in chars: " + selected.getLengthInChars() + " characters \n";
                extraInfo += application.getString("application.lengthInChars")+": " +  selected.getLengthInChars() + "\n";
                
//                extraInfo += "Time of the begining: " + selected.getBegin() + "\n";
                extraInfo += application.getString("application.beginTime")+": " + selected.getBegin() + "\n";
                
//                extraInfo += "Time of the end: " + selected.getEnd() + "\n";
                extraInfo += application.getString("application.endTime")+": " + selected.getEnd() + "\n";
...
//                System.err.println(e);
    ...
    public String[] normalizeStringsToEqualSize(String str1, String str2) {
    ...
    public void errorHighlight(int refID, String REF, String HYP) {
            ...
            for (int i = 1; i < analysisMatrix.length; i++) {
                for (int j = 1; j < analysisMatrix[0].length; j++) {
                    ...
                    switch (analysisMatrix[i][j]) {
                        case 's': {
                            normalisedStrings = normalizeStringsToEqualSize(refTokenised[i - 1], hypTokenised[j - 1]);
                            break;
                        }
                        case 'i': {
                            normalisedStrings = normalizeStringsToEqualSize("", hypTokenised[j - 1]);
                            break;
                        }
                        case 'd': {
                            normalisedStrings = normalizeStringsToEqualSize(refTokenised[i - 1], "");
                            break;
                        }
                    }
        ...
        /* Output the results of normalisation */
                //AH 21/02/2013 Internationalization
                info += application.getString("application.reference")+ refSentenceNormalisedTokenised + "\n";
//                info += "REF : " + refSentenceNormalisedTokenised + "\n";
                info += application.getString("application.hypothesis")+ hypSentenceNormalisedTokenised + "\n";
...
//                System.err.println(ex);
    ...
    public void updateScrolBars(int n) {
        ...
        this.jScrollPane6.getHorizontalScrollBar().setValue(n);
    }

    public void setFileTitle(String fullFileName) {
        String fileNames[] = fullFileName.split("\\.");
//        this.setTitle("Current file : " + fileNames[0]);
        this.setTitle(application.getString("application.currentFile")+": " + fileNames[0]);
    }
    ...
    public void searchAndHighlightErrors() {
        if (STM.getInstance().isLoaded() && CTM.getInstance().isLoaded()) {
            try {
                ...
                int searchType = 0;
                if (comboBoxValue.equals(application.getString("application.allErrors"))) {
//                if (comboBoxValue.equals("All Errors")) {
                    searchType = 1;
                } else if (comboBoxValue.equals(application.getString("application.deletion"))) {
//                    else if (comboBoxValue.equals("Deletion")) {
                    searchType = 2;
                } else if (comboBoxValue.equals(application.getString("application.substitution"))) {
//                    else if (comboBoxValue.equals("Substitution")) {
                    searchType = 3;
                } else if (comboBoxValue.equals(application.getString("application.insertion"))) {
